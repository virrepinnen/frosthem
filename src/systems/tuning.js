...
export const KNOBS = [
  ...
  { id: 'meleeWindup', group: 'Monsters', label: 'Melee wind-up', min: 0.15, max: 1.4, step: 0.05, unit: 's',
    note: 'How long the telegraph shows before the blow lands.' },
  { id: 'rangedWindup', group: 'Monsters', label: 'Ranged wind-up', min: 0.15, max: 1.6, step: 0.05, unit: 's' },
  { id: 'lungeWindup', group: 'Monsters', label: 'Charge wind-up', min: 0.1, max: 1.4, step: 0.05, unit: 's' },
