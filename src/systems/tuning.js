...
export const KNOBS = [
  ...
  // Two masters that move every automatic weapon at once, then a damage and a
  // rate for each of them. The four elemental ones are new and their numbers are
  // guesses — they are meant to be dragged rather than argued about.
  { id: 'autoDmg', group: 'Weapons', label: 'All damage', min: 0, max: 3, step: 0.05, unit: '×',
    note: 'Every automatic weapon at once. The benchmark is about a fifth of your damage.' },
  { id: 'autoRate', group: 'Weapons', label: 'All rate', min: 0.3, max: 3, step: 0.05, unit: '×' },
  { id: 'axeRadius', group: 'Weapons', label: 'Axe ring radius', min: 30, max: 180, step: 2, unit: 'px' },
  { id: 'axesDmg', group: 'Weapons', label: 'Axes damage', min: 0, max: 4, step: 0.05, unit: '×' },
  { id: 'axesRate', group: 'Weapons', label: 'Axes rate', min: 0.2, max: 4, step: 0.05, unit: '×' },
  { id: 'javDmg', group: 'Weapons', label: 'Javelins damage', min: 0, max: 4, step: 0.05, unit: '×' },
  { id: 'javRate', group: 'Weapons', label: 'Javelins rate', min: 0.2, max: 4, step: 0.05, unit: '×' },
  { id: 'boltDmg', group: 'Weapons', label: 'Miller damage', min: 0, max: 4, step: 0.05, unit: '×' },
  { id: 'boltRate', group: 'Weapons', label: 'Miller rate', min: 0.2, max: 4, step: 0.05, unit: '×' },
  { id: 'emberDmg', group: 'Weapons', label: 'Ember Wake damage', min: 0, max: 4, step: 0.05, unit: '×' },
  { id: 'emberRate', group: 'Weapons', label: 'Ember Wake rate', min: 0.2, max: 4, step: 0.05, unit: '×' },
  { id: 'frostDmg', group: 'Weapons', label: 'Hoarfrost damage', min: 0, max: 4, step: 0.05, unit: '×' },
  { id: 'frostRate', group: 'Weapons', label: 'Hoarfrost rate', min: 0.2, max: 4, step: 0.05, unit: '×' },
  { id: 'cairnDmg', group: 'Weapons', label: 'Rolling Cairn damage', min: 0, max: 4, step: 0.05, unit: '×' },
  { id: 'cairnRate', group: 'Weapons', label: 'Rolling Cairn rate', min: 0.2, max: 4, step: 0.05, unit: '×' },
  { id: 'galeDmg', group: 'Weapons', label: 'The Gale damage', min: 0, max: 4, step: 0.05, unit: '×' },
  { id: 'galeRate', group: 'Weapons', label: 'The Gale rate', min: 0.2, max: 4, step: 0.05, unit: '×' },
  { id: 'ravenDmg', group: 'Weapons', label: 'Raven flock damage', min: 0, max: 4, step: 0.05, unit: '×' },
  { id: 'ravenRate', group: 'Weapons', label: 'Raven flock rate', min: 0.2, max: 4, step: 0.05, unit: '×',
    note: 'Divides the ten-second wait.' },
  { id: 'wolfDmg', group: 'Weapons', label: 'The Pack damage', min: 0, max: 4, step: 0.05, unit: '×' },
  { id: 'wolfRate', group: 'Weapons', label: 'The Pack rate', min: 0.2, max: 4, step: 0.05, unit: '×',
    note: 'Divides the ten-second wait.' },
  { id: 'bearDmg', group: 'Weapons', label: 'The Bear damage', min: 0, max: 4, step: 0.05, unit: '×' },
  { id: 'bearRate', group: 'Weapons', label: 'The Bear rate', min: 0.2, max: 4, step: 0.05, unit: '×',
    note: 'Divides the ten-second wait.' },
  { id: 'elkDmg', group: 'Weapons', label: 'The White Elk damage', min: 0, max: 4, step: 0.05, unit: '×' },
  { id: 'elkRate', group: 'Weapons', label: 'The White Elk rate', min: 0.2, max: 4, step: 0.05, unit: '×',
    note: 'Divides the ten-second wait.' },
